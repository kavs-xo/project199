...
def clientthread(conn, addr):
    ...
    conn.send("You will receive a question. The answer to that question should be one of a, b, c or d. Choose wisely".encode('utf-8'))
    conn.send("Goodluck! \n \n".encode('utf-8'))
        ...
        try:
            ...
            if message:
                if message.lower()==answer:
                    ...
                    conn.send("Incorrect! Better luck next time!".encode('utf-8'))
